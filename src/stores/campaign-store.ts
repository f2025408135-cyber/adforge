 ...
 * result data, poster images, and UI state for the generation workflow.
 */
...
interface CampaignStore {
  ...
  // ── Poster actions ──────────────────────────────────────────
  setPosters: (p: PosterResult[]) => void;
  setPosterLoading: (l: boolean) => void;
  setPosterError: (e: string) => void;
  clearPosters: () => void;
}
...
export const useCampaignStore = create<CampaignStore>((set) => ({
  ...
  setApiKeyVisible: (v) => set({ apiKeyVisible: v }),
  ...
  // ── Poster actions ────────────────────────────────────────
  setPosters: (p) => set({ posters: p, posterLoading: false, posterError: "" }),
  setPosterLoading: (l) => set({ posterLoading: l }),
  setPosterError: (e) => set({ posterError: e, posterLoading: false }),
  clearPosters: () => set({ posters: [], posterError: "" }),
}));
